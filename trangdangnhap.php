...
;
    ...
    justify-content: center;"></i>
        ...
        <div style="flex: 1; background-color: #fff; display: flex; justify-content: space-around; align-items: center; padding: 0px;">
          <a href="./trangdangnhap.php" style="text-decoration: none; color: #0d6efd; display: flex; flex-direction: column; align-items: center;">
...
; 
  ...
  background: linear-gradient(45deg, #405DE6, #5851DB, #833AB4, #C13584, #E1306C, #FD1D1D, #F56040, #F77737, #FCAF45, #FFDC80);"></i></a> 
     ...
     <div class="container2 mt-5" style="margin-top: 1rem !important;">
    <div class="row justify-content-center" style="width: 827px;background-color: cornsilk;">
      <div class="col-md-6">
        <div class="card shadow">
          <div class="card-body" style="margin: 63px 8px;">
            <h3 class="text-center mb-4" style="margin: -65px;">Đăng nhập</h3>
            <form action="./Database/xulydangnhap.php" method="POST">
              <div class="mb-3">
